...
public:
    ...
    TurnResult od_PD_turn_controller(
    ...
    TurnResult od_PD_precision_controller(
        const Stamped3DVector& current_position, 
        Eigen::Vector3d& current_angle,
        Stamped3DVector&  target_position_pushed,
        Stamped3DVector&  target_position,
...
private:
    ...
    PDControllerGains pd_turning_gains{1.0, 0.01};
    PDControllerGains pd_waypoint_angular_gains{1.0, 0.01};
    PDControllerGains pd_waypoint_linear_gains{1.0, 0.01};
    PDControllerGains pd_linear_precision_angular_gains{1.0, 0.1};
    PDControllerGains pd_linear_precision_linear_gains{1.0, 0.01};
    PDControllerGains pd_aruco_angular_gains{1.0, 0.1};
    PDControllerGains pd_aruco_linear_gains{1.0, 0.01};
};